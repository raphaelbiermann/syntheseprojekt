...
%TODO Wann wird die Funktion aufgerufen?
...
%An der Stelle vielleicht nicht so relevant
\begin{comment}
...
\end{lstlisting}
%TODO Kommen die Ausgangssignale wieder in den AST-Baum für die endgültigen, einfachen Zuweisungen?
%TODO Zellen und Wires wurden im Modul erstellt, aber wie wird der Rest daran angeschlossen?
%TODO RTLIL Modul
...
%TODO Kürzen aufs das Wichtigste
\begin{lstlisting}[language=C++]
